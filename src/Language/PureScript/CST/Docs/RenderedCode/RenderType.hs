...
forall_ :: Pattern () PrettyPrintType ([(TypeVarVisibility, Text, PrettyPrintType)], PrettyPrintType)
...
renderTypeVars :: [(TypeVarVisibility, Text, PrettyPrintType)] -> RenderedCode
renderTypeVars tyVars = mintersperse sp (map renderTypeVar tyVars)

renderTypeVar :: (TypeVarVisibility, Text, PrettyPrintType) -> RenderedCode
renderTypeVar (vis, v, k) = mintersperse sp [mconcat [syntax "(", syntax $ typeVarVisibilityPrefix vis, typeVar v], syntax "::", mconcat [renderType' k, syntax ")"]]
