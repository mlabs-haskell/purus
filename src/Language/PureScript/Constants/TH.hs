...
mkPairDec :: VarToDec
mkPairDec mn prefix str =
  typedPatSyn
    (mkPrefixedName "P_" prefix str)
...
mkStringDec _ prefix str =
  typedPatSyn
    (mkPrefixedName "S_" prefix str)
